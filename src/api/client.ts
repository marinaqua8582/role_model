...
export function mapSheetDataToProgress(raw: any): StudentProgress {
  ...
  return {
    ...
    step5: {
      ...
      checkedFactualityRules: currentStep >= 5 ? [true, true, true, true, true] : [false, false, false, false, false],
      checkedDisclaimer: currentStep >= 5,
      checkedSafetyRules: currentStep >= 5 ? [true, true, true, true] : [false, false, false, false],
      allRulesChecked: currentStep >= 5,
    },
    step6: {
      chatbotName,
      initialPrompt,
